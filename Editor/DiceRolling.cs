...
public class DiceRolling : MonoBehaviour
{
    ...
    /// </summary>
    private int BaseRolling(int maxNum)
    {
        int num=Random.Range(1, maxNum+1);
        return num;
    }
    ...
    /// <returns></returns>
    public int OneDiceRolling(int numberOfFace)
    {
        if (numberOfFace < 1)
        {
    ...
    /// <returns></returns>
    public bool Check(int bonus,int difficult)
    {
    ...
    /// <param name="difficult"></param>
    /// <returns></returns>
    public int CheckPlus(int bonus,int difficult)
    {
        int res = -1;
        int pip = OneDiceRolling(20);
        if (pip + bonus >= difficult)
    ...
    /// <param name="vs"></param>
    /// <returns></returns>
    public int VaryDiceRolling(params int[] vs)
    {
        int sum = 0;
